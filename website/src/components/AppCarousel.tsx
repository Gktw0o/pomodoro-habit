...
const images = [
  { src: "/PomoHub/main-page.jpg", alt: "Main Dashboard - Overview of your day" },
  { src: "/PomoHub/pomodoro-page.jpg", alt: "Pomodoro Timer - Focus with customizable intervals" },
  { src: "/PomoHub/habits-page.jpg", alt: "Habit Tracker - Build streaks and consistency" },
  { src: "/PomoHub/calender-page.jpg", alt: "Calendar - Visualize your productivity history" },
  { src: "/PomoHub/todo-page.jpg", alt: "Todo List - Manage your tasks efficiently" },
  { src: "/PomoHub/goals-page.jpg", alt: "Goals - Track long-term progress" },
  { src: "/PomoHub/settings-page.jpg", alt: "Settings - Customize theme and background" },
];
